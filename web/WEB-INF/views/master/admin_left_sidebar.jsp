...
<div class="col-lg-3 col-md-3 col-sm-4 hidden-xs">
    <div class="list-group">
        ...
        <a href="<%=path %>/case/add_page" class="list-group-item <c:if test='${requestScope.admin_page == "addCase"}'>active</c:if>">添加案例</a>
        <a href="<%=path %>/news/add_page" class="list-group-item <c:if test='${requestScope.admin_page == "addNews"}'>active</c:if>">添加新闻</a>
